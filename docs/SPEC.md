...
fixtures and 20 parser error fixtures. Command metadata covers declaration
...
missing `kez`, required header colons, malformed anonymous-function, `yeni`,
postfix, and `paralel yap` expressions, unknown command typos such as `yzdır 1`,
