...
The current prototype summarizes top-level command node kinds, line numbers, and
immediate child block command counts, then compares them against the C++ parser
AST through
